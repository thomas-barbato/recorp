...
urlpatterns = [
    ...
    path("group/state/", core_views.group_modal_state, name="group_modal_state"),
    path("group/search_players/", core_views.search_players_for_group_invite, name="group_search_players"),
    ...
    path("bank/withdraw-to-ship/", core_views.bank_withdraw_to_ship, name="bank_withdraw_to_ship"),
    path("bank/deposit-to-account/", core_views.bank_deposit_to_account, name="bank_deposit_to_account"),
    path("bank/transfer-to-player/", core_views.bank_transfer_to_player, name="bank_transfer_to_player"),
