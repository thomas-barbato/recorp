...
class StoreInCache:
    ...
    def _fetch_npcs_bulk(self, sector_id: str) -> List[Dict]:
        ...
        return list(Npc.objects.filter(
            ...
            "ballistic_defense", "laser_defense", "torpedo_defense",
    ...
    def _fetch_pcs_bulk(self, sector_id: str) -> List[Dict]:
        ...
        return list(PlayerShipModule.objects.filter(
            ...
            "player_ship_id__current_torpedo_defense", "player_ship_id__current_ballistic_defense",
            "player_ship_id__current_laser_defense", "player_ship_id__max_torpedo_defense",
            "player_ship_id__max_ballistic_defense", "player_ship_id__max_laser_defense",
        ...
        try:
            ...
            npc_entry = {
                ...
                "ship": {
                    ...
                    "current_laser_defense": npc_data["laser_defense"],
                    "current_torpedo_defense": npc_data["torpedo_defense"],
        ...
        try:
            ...
            pc_entry = {
                ...
                "ship": {
                    ...
                    "current_laser_defense": pc_data["player_ship_id__current_laser_defense"],
                    "current_torpedo_defense": pc_data["player_ship_id__current_torpedo_defense"],
                    "max_ballistic_defense": pc_data["player_ship_id__max_ballistic_defense"],
                    "visible_zone": visible_zone,
                    "sonar_zone": sonar_zone,
                    "max_laser_defense": pc_data["player_ship_id__max_laser_defense"],
                    "max_torpedo_defense": pc_data["player_ship_id__max_torpedo_defense"],
