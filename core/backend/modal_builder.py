...
def _build_ship_module_type_limits(ship_obj) -> Dict[str, Optional[int]]:
    ...
    return {
        ...
        "DEFENSE_LASER": defense_limit,
        "DEFENSE_TORPEDO": defense_limit,
...
def build_pc_modal_data(player_id: int) -> Optional[Dict[str, Any]]:
    ...
    return {
        ...
        "ship": {
            ...
            "current_laser_defense": ship.current_laser_defense,
            "current_torpedo_defense": ship.current_torpedo_defense,
            "max_ballistic_defense": ship.max_ballistic_defense,
            "max_laser_defense": ship.max_laser_defense,
            "max_torpedo_defense": ship.max_torpedo_defense,
...
def build_npc_modal_data(npc_id: int) -> Optional[Dict[str, Any]]:
    ...
    return {
        ...
        "ship": {
            ...
            "current_laser_defense": npc.laser_defense,
            "current_torpedo_defense": npc.torpedo_defense,
            "max_ballistic_defense": npc.npc_template.max_ballistic_defense,
            "max_laser_defense": npc.npc_template.max_laser_defense,
            "max_torpedo_defense": npc.npc_template.max_torpedo_defense,
            "status": npc.status,
