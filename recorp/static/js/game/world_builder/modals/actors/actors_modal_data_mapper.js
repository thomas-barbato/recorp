    ...
    function createNpcModalData(npcData) {
        ...
        return {
            ...
            ship: {
                ...
                current_laser_defense: rt?.shields?.LASER ?? npcData.ship.current_laser_defense,
                max_laser_defense: npcData.ship.max_laser_defense,
                current_torpedo_defense: rt?.shields?.TORPEDO ?? npcData.ship.current_torpedo_defense,
                max_torpedo_defense: npcData.ship.max_torpedo_defense,
    ...
    function createPlayerModalData(playerData) {
        ...
        return {
            ...
            player: {
                ...
                current_ap: rt?.current_ap ?? playerData.user.current_ap,
                max_ap: rt?.max_ap ?? playerData.user.max_ap
            },
            ...
            ship: {
                ...
                current_laser_defense: rt?.shields?.LASER ?? playerData.ship.current_laser_defense,
                max_laser_defense: playerData.ship.max_laser_defense,
                current_torpedo_defense: rt?.shields?.TORPEDO ?? playerData.ship.current_torpedo_defense,
                max_torpedo_defense: playerData.ship.max_torpedo_defense,
